...
in downstream analyses.  We present \texttt{DiversityIndices.jl}, a Julia
...
We present \texttt{DiversityIndices.jl}, a Julia package designed to make
...
\texttt{DiversityIndices.jl} represents indices as small dispatchable objects
...
The benchmark corpus compares \texttt{DiversityIndices.jl} with R
...
\texttt{DiversityIndices.jl}, R \texttt{vegan}, SciPy, and scikit-bio-style
...
\texttt{DiversityIndices.jl} contributes to ecological informatics by treating
...
hardware change.  \texttt{DiversityIndices.jl} provides these elements through
...
figure-generation artifacts are available in the \texttt{DiversityIndices.jl}
