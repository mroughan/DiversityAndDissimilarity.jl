# DiversityIndices Benchmark Report
...
|---|---|---|---|---:|---:|---:|---:|---:|
| small | Julia | DiversityIndices.jl | richness | 120 | 80 | 5 | 100 | 6.33443e-6 |
| small | Julia | DiversityIndices.jl | shannon_entropy | 120 | 80 | 5 | 100 | 3.531551e-5 |
| small | Julia | DiversityIndices.jl | alpha_diversity | 120 | 80 | 5 | 100 | 0.00024690412 |
| small | Julia | DiversityIndices.jl | bray_curtis_distance_matrix | 120 | 80 | 5 | 100 | 0.00015949824 |
| small | Julia | DiversityIndices.jl | jaccard_distance_matrix | 120 | 80 | 5 | 100 | 2.399819e-5 |
| small | Julia | DiversityIndices.jl | hellinger_distance_matrix | 120 | 80 | 5 | 100 | 0.00018117313 |
...
| default | Julia | DiversityIndices.jl | richness | 400 | 200 | 5 | 20 | 5.7699249999999995e-5 |
| default | Julia | DiversityIndices.jl | shannon_entropy | 400 | 200 | 5 | 20 | 0.0003003264 |
| default | Julia | DiversityIndices.jl | alpha_diversity | 400 | 200 | 5 | 20 | 0.00109443295 |
| default | Julia | DiversityIndices.jl | bray_curtis_distance_matrix | 400 | 200 | 5 | 20 | 0.0048645998 |
| default | Julia | DiversityIndices.jl | jaccard_distance_matrix | 400 | 200 | 5 | 20 | 0.00031910660000000003 |
| default | Julia | DiversityIndices.jl | hellinger_distance_matrix | 400 | 200 | 5 | 20 | 0.0058180327499999995 |
...
| many_sites | Julia | DiversityIndices.jl | richness | 800 | 250 | 3 | 3 | 0.00016149233333333333 |
| many_sites | Julia | DiversityIndices.jl | shannon_entropy | 800 | 250 | 3 | 3 | 0.0007674520000000001 |
| many_sites | Julia | DiversityIndices.jl | alpha_diversity | 800 | 250 | 3 | 3 | 0.0024832976666666665 |
| many_sites | Julia | DiversityIndices.jl | bray_curtis_distance_matrix | 800 | 250 | 3 | 3 | 0.025966307666666664 |
| many_sites | Julia | DiversityIndices.jl | jaccard_distance_matrix | 800 | 250 | 3 | 3 | 0.0012407106666666667 |
| many_sites | Julia | DiversityIndices.jl | hellinger_distance_matrix | 800 | 250 | 3 | 3 | 0.026186475333333334 |
...
| wide | Julia | DiversityIndices.jl | richness | 300 | 1000 | 3 | 3 | 0.0002336193333333333 |
| wide | Julia | DiversityIndices.jl | shannon_entropy | 300 | 1000 | 3 | 3 | 0.0011446146666666667 |
| wide | Julia | DiversityIndices.jl | alpha_diversity | 300 | 1000 | 3 | 3 | 0.002219935666666667 |
| wide | Julia | DiversityIndices.jl | bray_curtis_distance_matrix | 300 | 1000 | 3 | 3 | 0.01782702833333333 |
| wide | Julia | DiversityIndices.jl | jaccard_distance_matrix | 300 | 1000 | 3 | 3 | 0.0007254226666666666 |
| wide | Julia | DiversityIndices.jl | hellinger_distance_matrix | 300 | 1000 | 3 | 3 | 0.01803770966666667 |
...
| large | Julia | DiversityIndices.jl | richness | 1200 | 300 | 2 | 1 | 0.000259373 |
| large | Julia | DiversityIndices.jl | shannon_entropy | 1200 | 300 | 2 | 1 | 0.001347677 |
| large | Julia | DiversityIndices.jl | alpha_diversity | 1200 | 300 | 2 | 1 | 0.003981658 |
| large | Julia | DiversityIndices.jl | bray_curtis_distance_matrix | 1200 | 300 | 2 | 1 | 0.086633236 |
| large | Julia | DiversityIndices.jl | jaccard_distance_matrix | 1200 | 300 | 2 | 1 | 0.003480309 |
| large | Julia | DiversityIndices.jl | hellinger_distance_matrix | 1200 | 300 | 2 | 1 | 0.072561824 |
